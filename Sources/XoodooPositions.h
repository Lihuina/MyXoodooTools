...
#ifndef _XOODOOPOSITIONS_H_
#define _XOODOOPOSITIONS_H_
...
class BitPosition {
public:
	/** The x-coordinate of the bit, 0 ≤ x < 4. */
	unsigned int x;
	/** The y-coordinate of the bit, 0 ≤ y < 3. */
	unsigned int y;
...
{
public:
	/** The x-coordinate of the column, 0 ≤ x < 4. */
	unsigned int x;
...
public:
	...
	/** This function returns an integer between 0 and 4*laneSize.
	  * @return x + 5*z
	  */
	inline unsigned int getXplus4Z() const { return x + 4 * z; }
...
public:
	...
	/** This function returns an integer between 0 and 3*laneSize.
	  * @return y + 5*z
	  */
	inline unsigned int getYplus3Z() const { return y + 3 * z; }
