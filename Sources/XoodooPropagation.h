...
public:
	/** The output Column patterns:
	  * - for DC, same as XoodooDCLC::diffChi;
	  * - for LC, same as XoodooDCLC::corrInvChi.
	  */
	vector<ListOfColumnPatterns> directColumnOutputListPerInput;
	/** The output Column patterns in the reverse direction:
	  * - for DC, same as XoodooDCLC::diffInvChi;
	  * - for LC, same as XoodooDCLC::corrChi.
	  */
	vector<ListOfColumnPatterns> reverseColumnOutputListPerInput;
	/** This attribute contains the same as directColumnOutputListPerInput
	  * but in the form of an affine space representation.
	  */
	/** The output Column patterns in an affine space representation.
      */
...
public:
    ...
    {
        return chiCompatibilityTable[beforeChi+8*afterChi];
    }
    ...
    /** This method checks the consistency of the trail given as parameter.
      * If an inconsistency is found, an exception is thColumnn and details
